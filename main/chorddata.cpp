...
void ChordData::printInitial(Language language) {
  if (language == English)
    fprint("Initial chord: ", m_notes, " ", ", ");
  else fprint("起始和弦：", m_notes, " ", ", ");
  fout << "(" << name << ")\n"
  ...
  fout << "n = " << s_size << ",  "
       << "m = " << m_notes_size << ",  "
       << "n/m = " << fixed << setprecision(2) << round_double((double) s_size / m_notes_size, 2) << ",  "
...
void ChordData::print(const ChordData &chord, Language language) {
  ...
  fout << "n = " << chord.s_size << ",  "
       << "m = " << chord.m_notes_size << ",  "
       << "n/m = " << fixed << setprecision(2) << round_double((double) chord.s_size / chord.m_notes_size, 2) << ",  "
...
void ChordData::print_analysis(const ChordData &antechord, const ChordData &postchord,
  ...
  sprint("", antechord.m_notes, " ", " -> ");
  sprint("", postchord.m_notes, " ", "\n\n");
  ...
  stream << "n = " << antechord.s_size << ",  "
         << "m = " << antechord.m_notes_size << ",  "
         << "n/m = " << fixed << setprecision(2) << round_double((double) antechord.s_size / antechord.m_notes_size, 2)
         << ",  "
  ...
  stream << "n = " << postchord.s_size << ",  "
         << "m = " << postchord.m_notes_size << ",  "
         << "n/m = " << fixed << setprecision(2) << round_double((double) postchord.s_size / postchord.m_notes_size, 2)
         << ",  "
...
bool larger_t_size(const ChordData &data1, const ChordData &data2) { return data1.m_notes_size >= data2.m_notes_size; }

bool larger_s_size(const ChordData &data1, const ChordData &data2) { return data1.s_size >= data2.s_size; }

bool larger_tension(const ChordData &data1, const ChordData &data2) { return data1.tension >= data2.tension; }

bool larger_thickness(const ChordData &data1, const ChordData &data2) { return data1.thickness >= data2.thickness; }

bool larger_root(const ChordData &data1, const ChordData &data2) { return data1.root >= data2.root; }

bool larger_span(const ChordData &data1, const ChordData &data2) { return data1.span >= data2.span; }

bool larger_sspan(const ChordData &data1, const ChordData &data2) { return data1.sspan >= data2.sspan; }

bool larger_g_center(const ChordData &data1, const ChordData &data2) { return data1.g_center >= data2.g_center; }

bool larger_chroma(const ChordData &data1, const ChordData &data2) { return data1.chroma >= data2.chroma; }

bool larger_chroma_old(const ChordData &data1, const ChordData &data2) { return data1.chroma_old >= data2.chroma_old; }

bool larger_common(const ChordData &data1, const ChordData &data2) { return data1.common_note >= data2.common_note; }

bool larger_sv(const ChordData &data1, const ChordData &data2) { return data1.sv >= data2.sv; }

bool larger_similarity(const ChordData &data1, const ChordData &data2) { return data1.similarity >= data2.similarity; }

bool larger_sim_orig(const ChordData &data1, const ChordData &data2) { return data1.sim_orig >= data2.sim_orig; }
...
bool smaller_t_size(const ChordData &data1, const ChordData &data2) { return data1.m_notes_size <= data2.m_notes_size; }

bool smaller_s_size(const ChordData &data1, const ChordData &data2) { return data1.s_size <= data2.s_size; }

bool smaller_tension(const ChordData &data1, const ChordData &data2) { return data1.tension <= data2.tension; }

bool smaller_thickness(const ChordData &data1, const ChordData &data2) { return data1.thickness <= data2.thickness; }

bool smaller_root(const ChordData &data1, const ChordData &data2) { return data1.root <= data2.root; }

bool smaller_span(const ChordData &data1, const ChordData &data2) { return data1.span <= data2.span; }

bool smaller_sspan(const ChordData &data1, const ChordData &data2) { return data1.sspan <= data2.sspan; }

bool smaller_g_center(const ChordData &data1, const ChordData &data2) { return data1.g_center <= data2.g_center; }

bool smaller_chroma(const ChordData &data1, const ChordData &data2) { return data1.chroma <= data2.chroma; }

bool smaller_chroma_old(const ChordData &data1, const ChordData &data2) { return data1.chroma_old <= data2.chroma_old; }

bool smaller_common(const ChordData &data1, const ChordData &data2) { return data1.common_note <= data2.common_note; }

bool smaller_sv(const ChordData &data1, const ChordData &data2) { return data1.sv <= data2.sv; }

bool smaller_similarity(const ChordData &data1, const ChordData &data2) { return data1.similarity <= data2.similarity; }

bool smaller_sim_orig(const ChordData &data1, const ChordData &data2) { return data1.sim_orig <= data2.sim_orig; }
